...
class HTMLTemplates {
    static generateDailyReportHTML(date, data) {
        const formattedDate = (0, date_fns_1.format)(date, 'EEEE, MMMM dd, yyyy');
        const generatedTime = (0, date_fns_1.format)(new Date(), 'MMMM dd, yyyy HH:mm:ss');
        return `
      <!DOCTYPE html>
      <html lang="en">
      <head>
            ...
            <div class="section">
              ...
              <div class="chart-container">
                ...
                <table class="data-table">
                  ...
                  <tbody>
                    ${data.inventory.lowStockAlerts.slice(0, 8).map((item) => `
                      <tr>
            ...
            <div class="section">
              ...
              <div class="chart-container">
                ...
                <table class="data-table">
                  ...
                  <tbody>
                    ${data.customers.debtSummary.topDebtors.slice(0, 5).map((debtor) => `
                      <tr>
