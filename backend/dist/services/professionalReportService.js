...
exports.ProfessionalReportService = void 0;
...
class ProfessionalReportService {
    ...
    async generateExcelReport(date = new Date()) {
        try {
    ...
    async generateHTMLPDFReport(date = new Date()) {
        try {
    ...
    async createExecutiveSummarySheet(workbook, date) {
        ...
        titleCell.value = `Daily Business Report - ${(0, date_fns_1.format)(date, 'MMMM dd, yyyy')}`;
        ...
        subtitleCell.value = `Generated on ${(0, date_fns_1.format)(new Date(), 'MMMM dd, yyyy HH:mm:ss')}`;
    ...
    async createSalesAnalysisSheet(workbook, date) {
        ...
        salesData.recentSales.forEach(sale => {
            worksheet.addRow([
                ...
                sale.amount,
                sale.paymentType,
                (0, date_fns_1.format)(new Date(sale.date), 'MMM dd, yyyy'),
    ...
    async createFinancialAnalysisSheet(workbook, date) {
    ...
    async createInventorySheet(workbook, date) {
    ...
    async createCustomerAnalysisSheet(workbook, date) {
    ...
    async createExpensesSheet(workbook, date) {
    ...
    addBorders(worksheet, startRow, endRow) {
    ...
    async generateHTMLContent(date) {
        ...
        return htmlTemplates_1.HTMLTemplates.generateDailyReportHTML(date, reportData);
    }
}
exports.ProfessionalReportService = ProfessionalReportService;
